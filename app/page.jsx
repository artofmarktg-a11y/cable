...
const advantages = [
  ...
  },
  {
    ...
    text: "Прямые поставки от производителей позволяют предлагать стабильные поставки и выгодные условия. Все, что вам может понадобиться для строительства и ремонта, скорее всего уже есть у нас.",
  },
];
